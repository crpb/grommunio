...
install -o root -g root -m 0644 -D "$SCRIPT_DIR"/grommunio-spam-run.override /etc/systemd/system/grommunio-spam-run.service.d/override.conf 
...
install -o grommunio -g gromoxcf -m 0640 "$SCRIPT_DIR"/spamrun.cfg /etc/gromox/
