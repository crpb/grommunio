...
# Usage: grom_repair_mailboxes domain
...
#grom_purge_messages abc.com all 730
...
# Example 2: Get the count of all messages older than 365 days (1 year) for all domains
#grom_query_purge_count all all 365
# Example 3: Get the count of all messages older than 730 days (2 years) for domain abc.com
#grom_query_purge_count abc.com all 730


## Cleanup user mail directories from old, deleted messages
# NOTE: this function is already included in grom_purge_messages above
...
# Usage: grom_backup_objects domain target_folder message_type
# domain         can be a domain name such as 'abc.com' or 'all' for all domains
...
#grom_backup_objects abc.com ~/backup all
...
# Example 1: Learn both ham and spam and consider the past 7 days
#grom_rspamd_learn all 7
# Example 2: Learn only ham and consider the past 30 days
#grom_rspamd_learn ham 30 (or grom_learn_ham 30)
# Example 3: Learn only spam and consider the past 30 days
#grom_rspamd_learn spam 30 (or grom_learn_spam 30)
